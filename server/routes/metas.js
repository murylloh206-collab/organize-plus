...
import { getMetasBySala, getMetaById, createMeta, updateMeta, deleteMeta, // <- Verifique se esta linha existe
getContribuicoesByMeta, createContribuicao, updateContribuicao, deleteContribuicao, getHistoricoByMeta } from "../storage.js";
const router = Router();
